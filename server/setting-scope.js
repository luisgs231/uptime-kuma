const { DEFAULT_ACCENT } = require("../src/util");
/**
...
const SYSTEM_SETTINGS = [
    ...
    // The keys the server generates for web push.
...
const USER_SETTINGS = [
    ...
    // The accent colour, so two people sharing an instance can tell their
    // own dashboard apart at a glance.
    "accentColor",
];
