    ...
    <div>
        ...
        <div v-if="installed" class="mb-2">
            <div class="mb-4">
                ...
                <div class="form-text">
                    ...
                    <br />
                    <a
                        href="https://github.com/luisgs231/uptime-kuma/wiki/Reverse-Proxy-with-Cloudflare-Tunnel"
                        target="_blank"
                    >
                        https://github.com/luisgs231/uptime-kuma/wiki/Reverse-Proxy-with-Cloudflare-Tunnel
                    </a>
                </div>
            </div>
        ...
        <div>
            ...
            <a href="https://github.com/luisgs231/uptime-kuma/wiki/Reverse-Proxy" target="_blank">
                https://github.com/luisgs231/uptime-kuma/wiki/Reverse-Proxy
            </a>
            .
        </div>
